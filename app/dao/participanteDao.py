...
class ParticipanteDao():
    ...
    def setParticipante(self, participante: ParticipanteModel):
        ...
        cursor.execute('insert into participantes (meio_transporte,horario_chegada,horario_saida, pcpf) values(%s ,%s ,%s ,%s)',
                       (participante.meioDeTransporte, participante.horarioChedada, participante.horarioSaida, participante.cpf))
