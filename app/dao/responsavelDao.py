...
class ResponsavelDao():
    ...
    def setResponsavel(self, reponsavel:ResponsavelModel):
        ...
        cursor.execute('insert into respnsaveis (pcpf, cargo) values(%s ,%s)',(reponsavel.cpf,reponsavel.cargo))       
    ...
    def updateResponsavel(self, reponsavel:ResponsavelModel):
        cursor = mysql.connection.cursor()
        cursor.execute('update respnsaveis set cargo = %s where pcpf = %s)',(reponsavel.cargo,reponsavel.cpf)) 
        mysql.connection.commit()
        cursor.close()
