...
class ParticipanteModel(PessoaModel):
    ...
    def __init__(self,pessoa:PessoaModel):
        super().__init__(pessoa.cpf,pessoa.nome,pessoa.sobrenome,pessoa.dataNacimento,pessoa.instituicao,pessoa.endereco,pessoa.contato)
    ...
    def toDict(self):      
        d = super().toDict()
        d.update({'meioDeTransporte':int(self.meioDeTransporte),'horarioChegada':str(self.horarioChedada),'horarioSaida':str(self.horarioSaida)})
        return d
