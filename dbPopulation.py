...
nome = ['Iago', 'Adonias', 'Zé', 'João', 'Maria',
        'Lucia', 'Fabia', 'Xuxa', 'Daniela', 'Mario']
sobrenome = ['da Silva', 'Araújo Galvão', 'Mercedes Benz', 'Barreto',
             'Roussef', 'Meirelles', 'Garcia', 'Medeiros', 'Araújo', 'Abdias']
nascimento = ['1980-11-30', '1972-09-12',
              '2001-02-01', '2005-11-01', '1999-08-10', ]
instituição = ['IFRN', 'IMD', 'UFRN', 'AABB', 'Valve']
endereço = ['Rua do Berilo, 122', 'Av. Tungstenio, 03',
            'Rua Gervasio Souto, 1002', 'Rua do Topázio, 09', 'Rua do Galo, 643']
...
def popular():
    ...
    for i in range(0, 10):
        ...
        participante = ParticipanteModel('00' + str(i), nome[x], sobrenome[x], nascimento[y], instituição[y], endereço[y], ContatoModel(
            '1', '00000000' + str(i), 'Isso é uma descrição'), z, '1' + str(x) + ':30:00', '14:00:00')
        ParticipanteDao.saveParticipante(participante, participante)

        localizacao = LocalModel(
            'Isso é a descrição do local', z, k, (x + 2)*(y + 2), 'Endereço ' + str(i))
